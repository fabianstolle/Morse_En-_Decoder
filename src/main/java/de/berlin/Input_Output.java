...
public class Input_Output {
    private ReadFile asciiCode = new ReadFile(42, "src\\main\\resources\\ASCIIcode.txt");
    private ReadFile morseCode = new ReadFile(42, "src\\main\\resources\\Morsecode.txt");
